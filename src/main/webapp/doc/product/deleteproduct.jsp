...
<body>
<blockquote class="layui-elem-quote">删除产品</blockquote>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" name="method" readonly class="layui-input" value="delete">
    </div>
</div>
<div class="layui-form-item">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
		...
		var formdata={"product_id":1};
		$.ajax({
			type:'post',
			url:'product/1?_method=delete',
			data: {},
...
<script>
    ...
    $("#testbtn").click(function () {
        ...
        $.ajax({
            type: 'post',
            url: $("[name='url']").val() + "/" + product_id + "?_method=delete",
            data: {},
            contentType: "application/json;charset=UTF-8",
            success: function (result) {
                result = JSON.stringify(result);
