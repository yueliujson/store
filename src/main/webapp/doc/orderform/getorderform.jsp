...
<body>
<blockquote class="layui-elem-quote">获取订单</blockquote>
<div class="layui-form-item">
    <label class="layui-form-label">地址</label>
    <div class="layui-input-block">
        <input type="text" name="url" readonly class="layui-input" value="<%=basePath%>orderForm">
    </div>
</div>
<div class="layui-form-item">
...
{"code":200,"message":"success",
          "data":{"data":{"user_id":4,"name":"王老五","sex":0,"phone":"123123123","username":"wanglao","userpass":"a5f0bfc268b3c6266bf9e39e6958ed1a2","state":0,"isDel":1,"createTime":"2023-03-02T11:55:44.000+00:00","lastLoginTime":null}}}
      </textarea>
    </div>
</div>
<div class="layui-form-item">
